(function(){
  ...
  async function init(){
    ...
    if("serviceWorker" in navigator){
      try{
        const reg=await navigator.serviceWorker.register("./portal-sw.js?v=6.15.09a",{updateViaCache:"none"});
        await reg.update();
      }catch(_){}
    }
  }
