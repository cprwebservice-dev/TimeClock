...
## V5.6.3
- ตารางกะสร้างช่องครบทุกวันของเดือนสำหรับพนักงานที่ยังปฏิบัติงาน จึงจัดกะล่วงหน้าได้
- เปิดให้จัดกะในวันหยุดประจำสัปดาห์และวันหยุดนักขัตฤกษ์ โดยกะที่ผู้ใช้กำหนดมีลำดับสูงสุด
- แสดงประเภทวันในปฏิทินด้วยพื้นหลัง/กรอบที่แตกต่างกัน
- ตารางรายละเอียดเวลาทำงานเพิ่ม เวลาเริ่มกะ และ เวลาสิ้นสุดกะ ก่อนคอลัมน์กะ
- เพิ่มคำอธิบายสถานะ ยังไม่ยืนยัน และ ยืนยันกะทันที ใน Popup
