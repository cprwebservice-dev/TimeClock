Time-Clock Enterprise V6.11.31 — Focused Dark Mode Polish
...
V6.11.31: ปรับ Darkmode Tab รูปแบบการทำงานครบ Hero, Summary, Filter, Table, Status Chips และ Template Cards


V6.11.32: Monthly Personal Overview ปรับสี Label วันหยุดนักขัตฤกษ์ และ Label วันที่กำหนดกะเป็นวันหยุด/วันหยุดประจำสัปดาห์ ให้แยกกันชัดขึ้น
