Time-Clock Enterprise V6.7.2 Compact Deploy
...
5) ติดตั้ง V6.7.2 Shift Settings by Work Pattern
6) รัน V6.7.2_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.7.2
...
V6.7.2 Statement Timeout Fix
- รัน V6.7.2_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.7.2 Template & Parameter Security
...
V6.7.2 HR Admin Parameter Visibility
...
V6.7.2 Effective Role Visibility Fix
...
V6.7.2 Fortnight Schedule View
...
V6.7.2 Pattern-Aware Shift Assignment
...
V6.7.2 Schedule Name & Visual Fix
...
V6.7.2 Schedule Helper Scope Fix
...
V6.7.2 Weekly Schedule & Shift Time
...
V6.7.2 Absence & Attendance Columns
...
- ต้องรัน V6.7.2_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.2 Attendance Columns & Template Code
...
- ต้องรัน V6.7.2_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.2 Attendance Detail Workspace
...
V6.7.2 Employee Multi-Select Filter
...
- ต้องรัน V6.7.2_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.2 Attendance Filter Layout Refinement
