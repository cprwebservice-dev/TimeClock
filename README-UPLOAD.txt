Time-Clock Enterprise V6.6.5 Compact Deploy
...
5) ติดตั้ง V6.6.5 Shift Settings by Work Pattern
6) รัน V6.6.5_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.6.5
...
V6.6.5 Statement Timeout Fix
- รัน V6.6.5_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.6.5 Template & Parameter Security
...
V6.6.5 HR Admin Parameter Visibility
...
V6.6.5 Effective Role Visibility Fix
...
V6.6.5 Fortnight Schedule View
...
V6.6.5 Pattern-Aware Shift Assignment
...
V6.6.5 Schedule Name & Visual Fix
...
V6.6.5 Schedule Helper Scope Fix
...
V6.6.5 Weekly Schedule & Shift Time
...
V6.6.5 Absence & Attendance Columns
...
- ต้องรัน V6.6.5_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.6.5 Attendance Columns & Template Code
...
- ต้องรัน V6.6.5_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ
