Time-Clock Enterprise V6.11.11 Compact Deploy
...
5) ติดตั้ง V6.11.11 Shift Settings by Work Pattern
6) รัน V6.11.11_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.11.11
...
V6.11.11 Statement Timeout Fix
- รัน V6.11.11_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.11.11 Template & Parameter Security
...
V6.11.11 HR Admin Parameter Visibility
...
V6.11.11 Effective Role Visibility Fix
...
V6.11.11 Fortnight Schedule View
...
V6.11.11 Pattern-Aware Shift Assignment
...
V6.11.11 Schedule Name & Visual Fix
...
V6.11.11 Schedule Helper Scope Fix
...
V6.11.11 Weekly Schedule & Shift Time
...
V6.11.11 Absence & Attendance Columns
...
- ต้องรัน V6.11.11_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.11 Attendance Columns & Template Code
...
- ต้องรัน V6.11.11_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.11 Attendance Detail Workspace
...
V6.11.11 Employee Multi-Select Filter
...
- ต้องรัน V6.11.11_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.11 Attendance Filter Layout Refinement
...
V6.11.11 Employee Dropdown Readability
...
V6.11.11 Simplified Attendance Filters
...
V6.11.11 Employee Filter Variable Fix
...
V6.11.11 Role & Manager Hierarchy
...
- ต้องรัน V6.11.11_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.11 Manager Scope by Email
...
V6.11.11 Organization Structure & Manager Assignment
...
- Employee Template V6.11.11 เพิ่มคอลัมน์ org_code


V6.11.11 Organization Import Safe Update & Upload Modal
...
V6.11.11 Organization Tree Drag & Drop
...
V6.11.11 Employee Import Template
...
V6.11.11 Move Zone to Organization Structure
...
V6.11.11 Organization Zone Popup Visibility
...
V6.11.11 Organization Structure UI Balance
...
V6.11.11 Move Area/Sub-area to Organization Structure
...
V6.11.11 Employee Directory Upgrade
...
V6.11.11 Employee Directory Layout & Cascading Organization Filter
...
V6.11.11 Organization Manager Search & UX/UI
...
V6.11.11 Fix Manager Profile Save
...
V6.11.11 User Account Management
...
V6.11.11 Invite Link First Setup
...
- ใช้ Invite Email Template V6.11.11 ที่แนบมา


V6.11.11 Account Button / Modal Fix
...
V6.11.11 Invite ConfirmationURL Fix
...
V6.11.11 Default Supabase Connection
...
V6.11.11 Prefetch-safe Password Recovery
...
V6.11.11 Password Visibility Toggle
...
V6.11.11 Recovery Client / OTP Send Fix
...
V6.11.11 Login Password Toggle
...
V6.11.11 Attendance Employee Timeout Fix
...
V6.11.11 Remove Review / Leave / Correction / Exception Modules
...
V6.11.11 Attendance Main Search Timeout Fix
...
- Sub-area ถูกกรองใน SQL V6.11.11
- V6.10.19 การตัด 4 Module ยังคงเดิม
- ส่วนอื่นคงเดิม


V6.11.11 Attendance Chunk Runtime Fix
...
- แก้ Build Version diagnostic เป็น V6.11.11
- ส่วนอื่นคงเดิม


V6.11.11 Weekly Schedule Scope Fix
...
V6.11.11 Weekly Schedule Matrix + Scope Diagnostics


V6.11.11 Schedule Start Date Guard
...
V6.11.11 User Scope + Schedule Filter + Gap Fix
...
V6.11.11 Auto Attendance Recalculation after Shift Change
...
V6.11.11 System Period Realtime Sync
...
V6.11.11 System Period Modal Fix
...
V6.11.11 System Period Loading Fix
...
V6.11.11 System Period Page Lifecycle Fix
...
- System Period module now sets data-system-period-module="6.11.11-ready" when it loads.
...
V6.11.11 CSV Import + Work Pattern Restore
...
V6.11.11 Remove Early Shift + Customer Template
...
V6.11.11 Work Pattern -> Schedule -> Attendance Linkage
...
V6.11.11 Employee Pattern + Locked Default Template + Shift Punch Columns
...
V6.11.11: Employee Pattern metadata reliability + Work Pattern UX redesign.
