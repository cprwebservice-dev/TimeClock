Time-Clock Enterprise V6.10.23 Compact Deploy
...
5) ติดตั้ง V6.10.23 Shift Settings by Work Pattern
6) รัน V6.10.23_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.10.23
...
V6.10.23 Statement Timeout Fix
- รัน V6.10.23_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.10.23 Template & Parameter Security
...
V6.10.23 HR Admin Parameter Visibility
...
V6.10.23 Effective Role Visibility Fix
...
V6.10.23 Fortnight Schedule View
...
V6.10.23 Pattern-Aware Shift Assignment
...
V6.10.23 Schedule Name & Visual Fix
...
V6.10.23 Schedule Helper Scope Fix
...
V6.10.23 Weekly Schedule & Shift Time
...
V6.10.23 Absence & Attendance Columns
...
- ต้องรัน V6.10.23_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.23 Attendance Columns & Template Code
...
- ต้องรัน V6.10.23_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.23 Attendance Detail Workspace
...
V6.10.23 Employee Multi-Select Filter
...
- ต้องรัน V6.10.23_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.23 Attendance Filter Layout Refinement
...
V6.10.23 Employee Dropdown Readability
...
V6.10.23 Simplified Attendance Filters
...
V6.10.23 Employee Filter Variable Fix
...
V6.10.23 Role & Manager Hierarchy
...
- ต้องรัน V6.10.23_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.23 Manager Scope by Email
...
V6.10.23 Organization Structure & Manager Assignment
...
- Employee Template V6.10.23 เพิ่มคอลัมน์ org_code


V6.10.23 Organization Import Safe Update & Upload Modal
...
V6.10.23 Organization Tree Drag & Drop
...
V6.10.23 Employee Import Template
...
V6.10.23 Move Zone to Organization Structure
...
V6.10.23 Organization Zone Popup Visibility
...
V6.10.23 Organization Structure UI Balance
...
V6.10.23 Move Area/Sub-area to Organization Structure
...
V6.10.23 Employee Directory Upgrade
...
V6.10.23 Employee Directory Layout & Cascading Organization Filter
...
V6.10.23 Organization Manager Search & UX/UI
...
V6.10.23 Fix Manager Profile Save
...
V6.10.23 User Account Management
...
V6.10.23 Invite Link First Setup
...
- ใช้ Invite Email Template V6.10.23 ที่แนบมา


V6.10.23 Account Button / Modal Fix
...
V6.10.23 Invite ConfirmationURL Fix
...
V6.10.23 Default Supabase Connection
...
V6.10.23 Prefetch-safe Password Recovery
...
V6.10.23 Password Visibility Toggle
...
V6.10.23 Recovery Client / OTP Send Fix
...
V6.10.23 Login Password Toggle
...
V6.10.23 Attendance Employee Timeout Fix
...
V6.10.23 Remove Review / Leave / Correction / Exception Modules
...
V6.10.23 Attendance Main Search Timeout Fix
...
- Sub-area ถูกกรองใน SQL V6.10.23
- V6.10.19 การตัด 4 Module ยังคงเดิม
- ส่วนอื่นคงเดิม


V6.10.23 Attendance Chunk Runtime Fix
...
- แก้ Build Version diagnostic เป็น V6.10.23
- ส่วนอื่นคงเดิม


V6.10.23 Weekly Schedule Scope Fix
