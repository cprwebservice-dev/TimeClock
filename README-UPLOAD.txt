Time-Clock Enterprise V6.10.10 Compact Deploy
...
5) ติดตั้ง V6.10.10 Shift Settings by Work Pattern
6) รัน V6.10.10_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.10.10
...
V6.10.10 Statement Timeout Fix
- รัน V6.10.10_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.10.10 Template & Parameter Security
...
V6.10.10 HR Admin Parameter Visibility
...
V6.10.10 Effective Role Visibility Fix
...
V6.10.10 Fortnight Schedule View
...
V6.10.10 Pattern-Aware Shift Assignment
...
V6.10.10 Schedule Name & Visual Fix
...
V6.10.10 Schedule Helper Scope Fix
...
V6.10.10 Weekly Schedule & Shift Time
...
V6.10.10 Absence & Attendance Columns
...
- ต้องรัน V6.10.10_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.10 Attendance Columns & Template Code
...
- ต้องรัน V6.10.10_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.10 Attendance Detail Workspace
...
V6.10.10 Employee Multi-Select Filter
...
- ต้องรัน V6.10.10_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.10 Attendance Filter Layout Refinement
...
V6.10.10 Employee Dropdown Readability
...
V6.10.10 Simplified Attendance Filters
...
V6.10.10 Employee Filter Variable Fix
...
V6.10.10 Role & Manager Hierarchy
...
- ต้องรัน V6.10.10_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.10 Manager Scope by Email
...
V6.10.10 Organization Structure & Manager Assignment
...
- Employee Template V6.10.10 เพิ่มคอลัมน์ org_code


V6.10.10 Organization Import Safe Update & Upload Modal
...
V6.10.10 Organization Tree Drag & Drop
...
V6.10.10 Employee Import Template
...
V6.10.10 Move Zone to Organization Structure
...
V6.10.10 Organization Zone Popup Visibility
...
V6.10.10 Organization Structure UI Balance
...
V6.10.10 Move Area/Sub-area to Organization Structure
...
V6.10.10 Employee Directory Upgrade
...
V6.10.10 Employee Directory Layout & Cascading Organization Filter
...
V6.10.10 Organization Manager Search & UX/UI
...
V6.10.10 Fix Manager Profile Save
...
V6.10.10 User Account Management
...
V6.10.10 Invite Link First Setup
...
- ใช้ Invite Email Template V6.10.10 ที่แนบมา


V6.10.10 Account Button / Modal Fix
...
V6.10.10 Invite ConfirmationURL Fix
...
V6.10.10 Default Supabase Connection
