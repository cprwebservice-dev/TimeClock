Time-Clock Enterprise V6.5.9 Compact Deploy
...
5) ติดตั้ง V6.5.9 Shift Settings by Work Pattern
6) รัน V6.5.9_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.5.9
...
V6.5.9 Statement Timeout Fix
- รัน V6.5.9_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.5.9 Template & Parameter Security
...
V6.5.9 HR Admin Parameter Visibility
...
V6.5.9 Effective Role Visibility Fix
...
V6.5.9 Fortnight Schedule View
