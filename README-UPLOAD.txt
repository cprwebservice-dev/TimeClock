Time-Clock Enterprise V6.10.1 Compact Deploy
...
5) ติดตั้ง V6.10.1 Shift Settings by Work Pattern
6) รัน V6.10.1_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.10.1
...
V6.10.1 Statement Timeout Fix
- รัน V6.10.1_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.10.1 Template & Parameter Security
...
V6.10.1 HR Admin Parameter Visibility
...
V6.10.1 Effective Role Visibility Fix
...
V6.10.1 Fortnight Schedule View
...
V6.10.1 Pattern-Aware Shift Assignment
...
V6.10.1 Schedule Name & Visual Fix
...
V6.10.1 Schedule Helper Scope Fix
...
V6.10.1 Weekly Schedule & Shift Time
...
V6.10.1 Absence & Attendance Columns
...
- ต้องรัน V6.10.1_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.1 Attendance Columns & Template Code
...
- ต้องรัน V6.10.1_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.1 Attendance Detail Workspace
...
V6.10.1 Employee Multi-Select Filter
...
- ต้องรัน V6.10.1_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.1 Attendance Filter Layout Refinement
...
V6.10.1 Employee Dropdown Readability
...
V6.10.1 Simplified Attendance Filters
...
V6.10.1 Employee Filter Variable Fix
...
V6.10.1 Role & Manager Hierarchy
...
- ต้องรัน V6.10.1_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.1 Manager Scope by Email
...
V6.10.1 Organization Structure & Manager Assignment
...
- Employee Template V6.10.1 เพิ่มคอลัมน์ org_code


V6.10.1 Organization Import Safe Update & Upload Modal
...
V6.10.1 Organization Tree Drag & Drop
...
V6.10.1 Employee Import Template
...
V6.10.1 Move Zone to Organization Structure
...
V6.10.1 Organization Zone Popup Visibility
...
- เพิ่ม Badge V6.10.1 ใน Popup เพื่อตรวจสอบชุด Deploy
- เพิ่ม Cache Busting app.css/app.js เป็น 6.10.1-20260806
- เพิ่ม window.__TIME_CLOCK_BUILD__ สำหรับตรวจสอบ Build ใน Console


V6.10.1 Add Office Zone
...
V6.10.1 Organization Structure UI Balance
...
V6.10.1 Move Area/Sub-area to Organization Structure
