Time-Clock Enterprise V6.11.6 Compact Deploy
...
5) ติดตั้ง V6.11.6 Shift Settings by Work Pattern
6) รัน V6.11.6_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.11.6
...
V6.11.6 Statement Timeout Fix
- รัน V6.11.6_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.11.6 Template & Parameter Security
...
V6.11.6 HR Admin Parameter Visibility
...
V6.11.6 Effective Role Visibility Fix
...
V6.11.6 Fortnight Schedule View
...
V6.11.6 Pattern-Aware Shift Assignment
...
V6.11.6 Schedule Name & Visual Fix
...
V6.11.6 Schedule Helper Scope Fix
...
V6.11.6 Weekly Schedule & Shift Time
...
V6.11.6 Absence & Attendance Columns
...
- ต้องรัน V6.11.6_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.6 Attendance Columns & Template Code
...
- ต้องรัน V6.11.6_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.6 Attendance Detail Workspace
...
V6.11.6 Employee Multi-Select Filter
...
- ต้องรัน V6.11.6_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.6 Attendance Filter Layout Refinement
...
V6.11.6 Employee Dropdown Readability
...
V6.11.6 Simplified Attendance Filters
...
V6.11.6 Employee Filter Variable Fix
...
V6.11.6 Role & Manager Hierarchy
...
- ต้องรัน V6.11.6_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.6 Manager Scope by Email
...
V6.11.6 Organization Structure & Manager Assignment
...
- Employee Template V6.11.6 เพิ่มคอลัมน์ org_code


V6.11.6 Organization Import Safe Update & Upload Modal
...
V6.11.6 Organization Tree Drag & Drop
...
V6.11.6 Employee Import Template
...
V6.11.6 Move Zone to Organization Structure
...
V6.11.6 Organization Zone Popup Visibility
...
V6.11.6 Organization Structure UI Balance
...
V6.11.6 Move Area/Sub-area to Organization Structure
...
V6.11.6 Employee Directory Upgrade
...
V6.11.6 Employee Directory Layout & Cascading Organization Filter
...
V6.11.6 Organization Manager Search & UX/UI
...
V6.11.6 Fix Manager Profile Save
...
V6.11.6 User Account Management
...
V6.11.6 Invite Link First Setup
...
- ใช้ Invite Email Template V6.11.6 ที่แนบมา


V6.11.6 Account Button / Modal Fix
...
V6.11.6 Invite ConfirmationURL Fix
...
V6.11.6 Default Supabase Connection
...
V6.11.6 Prefetch-safe Password Recovery
...
V6.11.6 Password Visibility Toggle
...
V6.11.6 Recovery Client / OTP Send Fix
...
V6.11.6 Attendance Employee Timeout Fix
...
V6.11.6 Remove Review / Leave / Correction / Exception Modules
...
V6.11.6 Attendance Main Search Timeout Fix
...
- Sub-area ถูกกรองใน SQL V6.11.6
- V6.10.19 การตัด 4 Module ยังคงเดิม
- ส่วนอื่นคงเดิม


V6.11.6 Attendance Chunk Runtime Fix
...
- แก้ Build Version diagnostic เป็น V6.11.6
- ส่วนอื่นคงเดิม


V6.11.6 Weekly Schedule Scope Fix
...
V6.11.6 Weekly Schedule Matrix + Scope Diagnostics


V6.11.6 Schedule Start Date Guard
...
V6.11.6 User Scope + Schedule Filter + Gap Fix
...
V6.11.6 Auto Attendance Recalculation after Shift Change
...
V6.11.6 System Period Realtime Sync
...
V6.11.6 System Period Modal Fix
...
V6.11.6 System Period Loading Fix
...
V6.11.6 System Period Page Lifecycle Fix
...
- System Period module now sets data-system-period-module="6.11.6-ready" when it loads.
...
V6.11.6 CSV Import + Work Pattern Restore
