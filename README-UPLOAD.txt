Time-Clock Enterprise V6.6.2 Compact Deploy
...
5) ติดตั้ง V6.6.2 Shift Settings by Work Pattern
6) รัน V6.6.2_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.6.2
...
V6.6.2 Statement Timeout Fix
- รัน V6.6.2_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.6.2 Template & Parameter Security
...
V6.6.2 HR Admin Parameter Visibility
...
V6.6.2 Effective Role Visibility Fix
...
V6.6.2 Fortnight Schedule View
...
V6.6.2 Pattern-Aware Shift Assignment
...
V6.6.2 Schedule Name & Visual Fix
...
V6.6.2 Schedule Helper Scope Fix
