Time-Clock Enterprise V6.7.4 Compact Deploy
...
5) ติดตั้ง V6.7.4 Shift Settings by Work Pattern
6) รัน V6.7.4_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.7.4
...
V6.7.4 Statement Timeout Fix
- รัน V6.7.4_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.7.4 Template & Parameter Security
...
V6.7.4 HR Admin Parameter Visibility
...
V6.7.4 Effective Role Visibility Fix
...
V6.7.4 Fortnight Schedule View
...
V6.7.4 Pattern-Aware Shift Assignment
...
V6.7.4 Schedule Name & Visual Fix
...
V6.7.4 Schedule Helper Scope Fix
...
V6.7.4 Weekly Schedule & Shift Time
...
V6.7.4 Absence & Attendance Columns
...
- ต้องรัน V6.7.4_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.4 Attendance Columns & Template Code
...
- ต้องรัน V6.7.4_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.4 Attendance Detail Workspace
...
V6.7.4 Employee Multi-Select Filter
...
- ต้องรัน V6.7.4_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.4 Attendance Filter Layout Refinement
...
V6.7.4 Employee Dropdown Readability
...
V6.7.4 Simplified Attendance Filters
