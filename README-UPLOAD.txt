Time-Clock Enterprise V6.7.0 Compact Deploy
...
5) ติดตั้ง V6.7.0 Shift Settings by Work Pattern
6) รัน V6.7.0_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.7.0
...
V6.7.0 Statement Timeout Fix
- รัน V6.7.0_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.7.0 Template & Parameter Security
...
V6.7.0 HR Admin Parameter Visibility
...
V6.7.0 Effective Role Visibility Fix
...
V6.7.0 Fortnight Schedule View
...
V6.7.0 Pattern-Aware Shift Assignment
...
V6.7.0 Schedule Name & Visual Fix
...
V6.7.0 Schedule Helper Scope Fix
...
V6.7.0 Weekly Schedule & Shift Time
...
V6.7.0 Absence & Attendance Columns
...
- ต้องรัน V6.7.0_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.0 Attendance Columns & Template Code
...
- ต้องรัน V6.7.0_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.0 Attendance Detail Workspace
