Time-Clock Enterprise V6.7.3 Compact Deploy
...
5) ติดตั้ง V6.7.3 Shift Settings by Work Pattern
6) รัน V6.7.3_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.7.3
...
V6.7.3 Statement Timeout Fix
- รัน V6.7.3_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.7.3 Template & Parameter Security
...
V6.7.3 HR Admin Parameter Visibility
...
V6.7.3 Effective Role Visibility Fix
...
V6.7.3 Fortnight Schedule View
...
V6.7.3 Pattern-Aware Shift Assignment
...
V6.7.3 Schedule Name & Visual Fix
...
V6.7.3 Schedule Helper Scope Fix
...
V6.7.3 Weekly Schedule & Shift Time
...
V6.7.3 Absence & Attendance Columns
...
- ต้องรัน V6.7.3_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.3 Attendance Columns & Template Code
...
- ต้องรัน V6.7.3_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.3 Attendance Detail Workspace
...
V6.7.3 Employee Multi-Select Filter
...
- ต้องรัน V6.7.3_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.7.3 Attendance Filter Layout Refinement
...
V6.7.3 Employee Dropdown Readability
