Time-Clock Enterprise V6.10.2 Compact Deploy
...
5) ติดตั้ง V6.10.2 Shift Settings by Work Pattern
6) รัน V6.10.2_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.10.2
...
V6.10.2 Statement Timeout Fix
- รัน V6.10.2_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.10.2 Template & Parameter Security
...
V6.10.2 HR Admin Parameter Visibility
...
V6.10.2 Effective Role Visibility Fix
...
V6.10.2 Fortnight Schedule View
...
V6.10.2 Pattern-Aware Shift Assignment
...
V6.10.2 Schedule Name & Visual Fix
...
V6.10.2 Schedule Helper Scope Fix
...
V6.10.2 Weekly Schedule & Shift Time
...
V6.10.2 Absence & Attendance Columns
...
- ต้องรัน V6.10.2_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.2 Attendance Columns & Template Code
...
- ต้องรัน V6.10.2_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.2 Attendance Detail Workspace
...
V6.10.2 Employee Multi-Select Filter
...
- ต้องรัน V6.10.2_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.2 Attendance Filter Layout Refinement
...
V6.10.2 Employee Dropdown Readability
...
V6.10.2 Simplified Attendance Filters
...
V6.10.2 Employee Filter Variable Fix
...
V6.10.2 Role & Manager Hierarchy
...
- ต้องรัน V6.10.2_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.2 Manager Scope by Email
...
V6.10.2 Organization Structure & Manager Assignment
...
- Employee Template V6.10.2 เพิ่มคอลัมน์ org_code


V6.10.2 Organization Import Safe Update & Upload Modal
...
V6.10.2 Organization Tree Drag & Drop
...
V6.10.2 Employee Import Template
...
V6.10.2 Move Zone to Organization Structure
...
V6.10.2 Organization Zone Popup Visibility
...
V6.10.2 Organization Structure UI Balance
...
V6.10.2 Move Area/Sub-area to Organization Structure
...
V6.10.2 Employee Directory Upgrade
