Time-Clock Enterprise V6.11.10 Compact Deploy
...
5) ติดตั้ง V6.11.10 Shift Settings by Work Pattern
6) รัน V6.11.10_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.11.10
...
V6.11.10 Statement Timeout Fix
- รัน V6.11.10_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.11.10 Template & Parameter Security
...
V6.11.10 HR Admin Parameter Visibility
...
V6.11.10 Effective Role Visibility Fix
...
V6.11.10 Fortnight Schedule View
...
V6.11.10 Pattern-Aware Shift Assignment
...
V6.11.10 Schedule Name & Visual Fix
...
V6.11.10 Schedule Helper Scope Fix
...
V6.11.10 Weekly Schedule & Shift Time
...
V6.11.10 Absence & Attendance Columns
...
- ต้องรัน V6.11.10_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.10 Attendance Columns & Template Code
...
- ต้องรัน V6.11.10_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.10 Attendance Detail Workspace
...
V6.11.10 Employee Multi-Select Filter
...
- ต้องรัน V6.11.10_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.10 Attendance Filter Layout Refinement
...
V6.11.10 Employee Dropdown Readability
...
V6.11.10 Simplified Attendance Filters
...
V6.11.10 Employee Filter Variable Fix
...
V6.11.10 Role & Manager Hierarchy
...
- ต้องรัน V6.11.10_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.10 Manager Scope by Email
...
V6.11.10 Organization Structure & Manager Assignment
...
- Employee Template V6.11.10 เพิ่มคอลัมน์ org_code


V6.11.10 Organization Import Safe Update & Upload Modal
...
V6.11.10 Organization Tree Drag & Drop
...
V6.11.10 Employee Import Template
...
V6.11.10 Move Zone to Organization Structure
...
V6.11.10 Organization Zone Popup Visibility
...
V6.11.10 Organization Structure UI Balance
...
V6.11.10 Move Area/Sub-area to Organization Structure
...
V6.11.10 Employee Directory Upgrade
...
V6.11.10 Employee Directory Layout & Cascading Organization Filter
...
V6.11.10 Organization Manager Search & UX/UI
...
V6.11.10 Fix Manager Profile Save
...
V6.11.10 User Account Management
...
V6.11.10 Invite Link First Setup
...
- ใช้ Invite Email Template V6.11.10 ที่แนบมา


V6.11.10 Account Button / Modal Fix
...
V6.11.10 Invite ConfirmationURL Fix
...
V6.11.10 Default Supabase Connection
...
V6.11.10 Prefetch-safe Password Recovery
...
V6.11.10 Password Visibility Toggle
...
V6.11.10 Recovery Client / OTP Send Fix
...
V6.11.10 Login Password Toggle
...
V6.11.10 Attendance Employee Timeout Fix
...
V6.11.10 Remove Review / Leave / Correction / Exception Modules
...
V6.11.10 Attendance Main Search Timeout Fix
...
- Sub-area ถูกกรองใน SQL V6.11.10
- V6.10.19 การตัด 4 Module ยังคงเดิม
- ส่วนอื่นคงเดิม


V6.11.10 Attendance Chunk Runtime Fix
...
- แก้ Build Version diagnostic เป็น V6.11.10
- ส่วนอื่นคงเดิม


V6.11.10 Weekly Schedule Scope Fix
...
V6.11.10 Weekly Schedule Matrix + Scope Diagnostics


V6.11.10 Schedule Start Date Guard
...
V6.11.10 User Scope + Schedule Filter + Gap Fix
...
V6.11.10 Auto Attendance Recalculation after Shift Change
...
V6.11.10 System Period Realtime Sync
...
V6.11.10 System Period Modal Fix
...
V6.11.10 System Period Loading Fix
...
V6.11.10 System Period Page Lifecycle Fix
...
- System Period module now sets data-system-period-module="6.11.10-ready" when it loads.
...
V6.11.10 CSV Import + Work Pattern Restore
...
V6.11.10 Remove Early Shift + Customer Template
...
V6.11.10 Work Pattern -> Schedule -> Attendance Linkage
...
V6.11.10 Employee Pattern + Locked Default Template + Shift Punch Columns
