Time-Clock Enterprise V6.10.3 Compact Deploy
...
5) ติดตั้ง V6.10.3 Shift Settings by Work Pattern
6) รัน V6.10.3_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.10.3
...
V6.10.3 Statement Timeout Fix
- รัน V6.10.3_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.10.3 Template & Parameter Security
...
V6.10.3 HR Admin Parameter Visibility
...
V6.10.3 Effective Role Visibility Fix
...
V6.10.3 Fortnight Schedule View
...
V6.10.3 Pattern-Aware Shift Assignment
...
V6.10.3 Schedule Name & Visual Fix
...
V6.10.3 Schedule Helper Scope Fix
...
V6.10.3 Weekly Schedule & Shift Time
...
V6.10.3 Absence & Attendance Columns
...
- ต้องรัน V6.10.3_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.3 Attendance Columns & Template Code
...
- ต้องรัน V6.10.3_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.3 Attendance Detail Workspace
...
V6.10.3 Employee Multi-Select Filter
...
- ต้องรัน V6.10.3_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.3 Attendance Filter Layout Refinement
...
V6.10.3 Employee Dropdown Readability
...
V6.10.3 Simplified Attendance Filters
...
V6.10.3 Employee Filter Variable Fix
...
V6.10.3 Role & Manager Hierarchy
...
- ต้องรัน V6.10.3_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.3 Manager Scope by Email
...
V6.10.3 Organization Structure & Manager Assignment
...
- Employee Template V6.10.3 เพิ่มคอลัมน์ org_code


V6.10.3 Organization Import Safe Update & Upload Modal
...
V6.10.3 Organization Tree Drag & Drop
...
V6.10.3 Employee Import Template
...
V6.10.3 Move Zone to Organization Structure
...
V6.10.3 Organization Zone Popup Visibility
...
V6.10.3 Organization Structure UI Balance
...
V6.10.3 Move Area/Sub-area to Organization Structure
...
V6.10.3 Employee Directory Upgrade
...
V6.10.3 Employee Directory Layout & Cascading Organization Filter
