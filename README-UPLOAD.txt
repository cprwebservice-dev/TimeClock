Time-Clock Enterprise V6.10.21 Compact Deploy
...
5) ติดตั้ง V6.10.21 Shift Settings by Work Pattern
6) รัน V6.10.21_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.10.21
...
V6.10.21 Statement Timeout Fix
- รัน V6.10.21_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.10.21 Template & Parameter Security
...
V6.10.21 HR Admin Parameter Visibility
...
V6.10.21 Effective Role Visibility Fix
...
V6.10.21 Fortnight Schedule View
...
V6.10.21 Pattern-Aware Shift Assignment
...
V6.10.21 Schedule Name & Visual Fix
...
V6.10.21 Schedule Helper Scope Fix
...
V6.10.21 Weekly Schedule & Shift Time
...
V6.10.21 Absence & Attendance Columns
...
- ต้องรัน V6.10.21_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.21 Attendance Columns & Template Code
...
- ต้องรัน V6.10.21_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.21 Attendance Detail Workspace
...
V6.10.21 Employee Multi-Select Filter
...
- ต้องรัน V6.10.21_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.21 Attendance Filter Layout Refinement
...
V6.10.21 Employee Dropdown Readability
...
V6.10.21 Simplified Attendance Filters
...
V6.10.21 Employee Filter Variable Fix
...
V6.10.21 Role & Manager Hierarchy
...
- ต้องรัน V6.10.21_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.21 Manager Scope by Email
...
V6.10.21 Organization Structure & Manager Assignment
...
- Employee Template V6.10.21 เพิ่มคอลัมน์ org_code


V6.10.21 Organization Import Safe Update & Upload Modal
...
V6.10.21 Organization Tree Drag & Drop
...
V6.10.21 Employee Import Template
...
V6.10.21 Move Zone to Organization Structure
...
V6.10.21 Organization Zone Popup Visibility
...
V6.10.21 Organization Structure UI Balance
...
V6.10.21 Move Area/Sub-area to Organization Structure
...
V6.10.21 Employee Directory Upgrade
...
V6.10.21 Employee Directory Layout & Cascading Organization Filter
...
V6.10.21 Organization Manager Search & UX/UI
...
V6.10.21 Fix Manager Profile Save
...
V6.10.21 User Account Management
...
V6.10.21 Invite Link First Setup
...
- ใช้ Invite Email Template V6.10.21 ที่แนบมา


V6.10.21 Account Button / Modal Fix
...
V6.10.21 Invite ConfirmationURL Fix
...
V6.10.21 Default Supabase Connection
...
V6.10.21 Prefetch-safe Password Recovery
...
V6.10.21 Password Visibility Toggle
...
V6.10.21 Recovery Client / OTP Send Fix
...
V6.10.21 Login Password Toggle
...
V6.10.21 Attendance Employee Timeout Fix
...
V6.10.21 Remove Review / Leave / Correction / Exception Modules
...
V6.10.21 Attendance Main Search Timeout Fix
...
- Sub-area ถูกกรองใน SQL V6.10.21
- V6.10.19 การตัด 4 Module ยังคงเดิม
- ส่วนอื่นคงเดิม


V6.10.21 Attendance Chunk Runtime Fix
