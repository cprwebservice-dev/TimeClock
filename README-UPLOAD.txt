Time-Clock Enterprise V6.11.15 Compact Deploy
...
5) ติดตั้ง V6.11.15 Shift Settings by Work Pattern
6) รัน V6.11.15_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.11.15
...
V6.11.15 Statement Timeout Fix
- รัน V6.11.15_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.11.15 Template & Parameter Security
...
V6.11.15 HR Admin Parameter Visibility
...
V6.11.15 Effective Role Visibility Fix
...
V6.11.15 Fortnight Schedule View
...
V6.11.15 Pattern-Aware Shift Assignment
...
V6.11.15 Schedule Name & Visual Fix
...
V6.11.15 Schedule Helper Scope Fix
...
V6.11.15 Weekly Schedule & Shift Time
...
V6.11.15 Absence & Attendance Columns
...
- ต้องรัน V6.11.15_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.15 Attendance Columns & Template Code
...
- ต้องรัน V6.11.15_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.15 Attendance Detail Workspace
...
V6.11.15 Employee Multi-Select Filter
...
- ต้องรัน V6.11.15_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.15 Attendance Filter Layout Refinement
...
V6.11.15 Employee Dropdown Readability
...
V6.11.15 Simplified Attendance Filters
...
V6.11.15 Employee Filter Variable Fix
...
V6.11.15 Role & Manager Hierarchy
...
- ต้องรัน V6.11.15_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.15 Manager Scope by Email
...
V6.11.15 Organization Structure & Manager Assignment
...
- Employee Template V6.11.15 เพิ่มคอลัมน์ org_code


V6.11.15 Organization Import Safe Update & Upload Modal
...
V6.11.15 Organization Tree Drag & Drop
...
V6.11.15 Employee Import Template
...
V6.11.15 Move Zone to Organization Structure
...
V6.11.15 Organization Zone Popup Visibility
...
V6.11.15 Organization Structure UI Balance
...
V6.11.15 Move Area/Sub-area to Organization Structure
...
V6.11.15 Employee Directory Upgrade
...
V6.11.15 Employee Directory Layout & Cascading Organization Filter
...
V6.11.15 Organization Manager Search & UX/UI
...
V6.11.15 Fix Manager Profile Save
...
V6.11.15 User Account Management
...
V6.11.15 Invite Link First Setup
...
- ใช้ Invite Email Template V6.11.15 ที่แนบมา


V6.11.15 Account Button / Modal Fix
...
V6.11.15 Invite ConfirmationURL Fix
...
V6.11.15 Default Supabase Connection
...
V6.11.15 Prefetch-safe Password Recovery
...
V6.11.15 Password Visibility Toggle
...
V6.11.15 Recovery Client / OTP Send Fix
...
V6.11.15 Login Password Toggle
...
V6.11.15 Attendance Employee Timeout Fix
...
V6.11.15 Remove Review / Leave / Correction / Exception Modules
...
V6.11.15 Attendance Main Search Timeout Fix
...
- Sub-area ถูกกรองใน SQL V6.11.15
- V6.10.19 การตัด 4 Module ยังคงเดิม
- ส่วนอื่นคงเดิม


V6.11.15 Attendance Chunk Runtime Fix
...
- แก้ Build Version diagnostic เป็น V6.11.15
- ส่วนอื่นคงเดิม


V6.11.15 Weekly Schedule Scope Fix
...
V6.11.15 Weekly Schedule Matrix + Scope Diagnostics


V6.11.15 Schedule Start Date Guard
...
V6.11.15 User Scope + Schedule Filter + Gap Fix
...
V6.11.15 Auto Attendance Recalculation after Shift Change
...
V6.11.15 System Period Realtime Sync
...
V6.11.15 System Period Modal Fix
...
V6.11.15 System Period Loading Fix
...
V6.11.15 System Period Page Lifecycle Fix
...
- System Period module now sets data-system-period-module="6.11.15-ready" when it loads.
...
V6.11.15 CSV Import + Work Pattern Restore
...
V6.11.15 Remove Early Shift + Customer Template
...
V6.11.15 Work Pattern -> Schedule -> Attendance Linkage
...
V6.11.15 Employee Pattern + Locked Default Template + Shift Punch Columns
...
V6.11.15: Employee Pattern metadata reliability + Work Pattern UX redesign.


V6.11.15 Schedule view switch
...
V6.11.15 Team daily summary + drill-down drawer
...
V6.11.15 Team Visual Alignment
- Team view uses the same surface/background family as Person view.
- Team summary category chips reuse Person-view shift colors: day blue, night purple, off slate, leave green.
- Daily team labels reduced from 136px to 84px.
- Team unit cells reduced to the same row height.
- Team headers and grid borders aligned with the individual weekly schedule table.
- Drawer behavior/data unchanged.


V6.11.15 Team View UX Refresh
- Reworked team daily labels into compact 3-column summary: เช้า / ดึก / หยุด.
- Total and confirmation ratio moved to the top for faster scanning.
- Leave and review appear only when relevant.
- Reduced row/cell height to ~76px.
