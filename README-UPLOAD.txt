Time-Clock Enterprise V6.11.1 Compact Deploy
...
5) ติดตั้ง V6.11.1 Shift Settings by Work Pattern
6) รัน V6.11.1_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.11.1
...
V6.11.1 Statement Timeout Fix
- รัน V6.11.1_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.11.1 Template & Parameter Security
...
V6.11.1 HR Admin Parameter Visibility
...
V6.11.1 Effective Role Visibility Fix
...
V6.11.1 Fortnight Schedule View
...
V6.11.1 Pattern-Aware Shift Assignment
...
V6.11.1 Schedule Name & Visual Fix
...
V6.11.1 Schedule Helper Scope Fix
...
V6.11.1 Weekly Schedule & Shift Time
...
V6.11.1 Absence & Attendance Columns
...
- ต้องรัน V6.11.1_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.1 Attendance Columns & Template Code
...
- ต้องรัน V6.11.1_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.1 Attendance Detail Workspace
...
V6.11.1 Employee Multi-Select Filter
...
- ต้องรัน V6.11.1_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.1 Attendance Filter Layout Refinement
...
V6.11.1 Employee Dropdown Readability
...
V6.11.1 Simplified Attendance Filters
...
V6.11.1 Employee Filter Variable Fix
...
V6.11.1 Role & Manager Hierarchy
...
- ต้องรัน V6.11.1_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.11.1 Manager Scope by Email
...
V6.11.1 Organization Structure & Manager Assignment
...
- Employee Template V6.11.1 เพิ่มคอลัมน์ org_code


V6.11.1 Organization Import Safe Update & Upload Modal
...
V6.11.1 Organization Tree Drag & Drop
...
V6.11.1 Employee Import Template
...
V6.11.1 Move Zone to Organization Structure
...
V6.11.1 Organization Zone Popup Visibility
...
V6.11.1 Organization Structure UI Balance
...
V6.11.1 Move Area/Sub-area to Organization Structure
...
V6.11.1 Employee Directory Upgrade
...
V6.11.1 Employee Directory Layout & Cascading Organization Filter
...
V6.11.1 Organization Manager Search & UX/UI
...
V6.11.1 Fix Manager Profile Save
...
V6.11.1 User Account Management
...
V6.11.1 Invite Link First Setup
...
- ใช้ Invite Email Template V6.11.1 ที่แนบมา


V6.11.1 Account Button / Modal Fix
...
V6.11.1 Invite ConfirmationURL Fix
...
V6.11.1 Default Supabase Connection
...
V6.11.1 Prefetch-safe Password Recovery
...
V6.11.1 Password Visibility Toggle
...
V6.11.1 Recovery Client / OTP Send Fix
...
V6.11.1 Attendance Employee Timeout Fix
...
V6.11.1 Remove Review / Leave / Correction / Exception Modules
...
V6.11.1 Attendance Main Search Timeout Fix
...
- Sub-area ถูกกรองใน SQL V6.11.1
- V6.10.19 การตัด 4 Module ยังคงเดิม
- ส่วนอื่นคงเดิม


V6.11.1 Attendance Chunk Runtime Fix
...
- แก้ Build Version diagnostic เป็น V6.11.1
- ส่วนอื่นคงเดิม


V6.11.1 Weekly Schedule Scope Fix
...
V6.11.1 Weekly Schedule Matrix + Scope Diagnostics


V6.11.1 Schedule Start Date Guard
...
V6.11.1 User Scope + Schedule Filter + Gap Fix
...
V6.11.1 Auto Attendance Recalculation after Shift Change
...
V6.11.1 System Period Realtime Sync
