Time-Clock Enterprise V6.10.7 Compact Deploy
...
5) ติดตั้ง V6.10.7 Shift Settings by Work Pattern
6) รัน V6.10.7_VERIFY.sql
7) อัปโหลดไฟล์ใน ZIP นี้แทนชุดเดิม แล้วกด Ctrl+F5

ฟังก์ชันหน้าเว็บ V6.10.7
...
V6.10.7 Statement Timeout Fix
- รัน V6.10.7_SHIFT_RECALC_JOB_TIMEOUT_FIX.sql หลัง V6.5.3
...
V6.10.7 Template & Parameter Security
...
V6.10.7 HR Admin Parameter Visibility
...
V6.10.7 Effective Role Visibility Fix
...
V6.10.7 Fortnight Schedule View
...
V6.10.7 Pattern-Aware Shift Assignment
...
V6.10.7 Schedule Name & Visual Fix
...
V6.10.7 Schedule Helper Scope Fix
...
V6.10.7 Weekly Schedule & Shift Time
...
V6.10.7 Absence & Attendance Columns
...
- ต้องรัน V6.10.7_ABSENCE_CALCULATION.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.7 Attendance Columns & Template Code
...
- ต้องรัน V6.10.7_TEMPLATE_CODE_AND_ATTENDANCE_COLUMNS.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.7 Attendance Detail Workspace
...
V6.10.7 Employee Multi-Select Filter
...
- ต้องรัน V6.10.7_ATTENDANCE_EMPLOYEE_FILTER.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.7 Attendance Filter Layout Refinement
...
V6.10.7 Employee Dropdown Readability
...
V6.10.7 Simplified Attendance Filters
...
V6.10.7 Employee Filter Variable Fix
...
V6.10.7 Role & Manager Hierarchy
...
- ต้องรัน V6.10.7_ROLE_MANAGER_HIERARCHY.sql ก่อนอัปโหลดหน้าเว็บ


V6.10.7 Manager Scope by Email
...
V6.10.7 Organization Structure & Manager Assignment
...
- Employee Template V6.10.7 เพิ่มคอลัมน์ org_code


V6.10.7 Organization Import Safe Update & Upload Modal
...
V6.10.7 Organization Tree Drag & Drop
...
V6.10.7 Employee Import Template
...
V6.10.7 Move Zone to Organization Structure
...
V6.10.7 Organization Zone Popup Visibility
...
V6.10.7 Organization Structure UI Balance
...
V6.10.7 Move Area/Sub-area to Organization Structure
...
V6.10.7 Employee Directory Upgrade
...
V6.10.7 Employee Directory Layout & Cascading Organization Filter
...
V6.10.7 Organization Manager Search & UX/UI
...
V6.10.7 Fix Manager Profile Save
...
V6.10.7 User Account Management
...
V6.10.7 Invite Link First Setup
...
- ใช้ Invite Email Template V6.10.7 ที่แนบมา
